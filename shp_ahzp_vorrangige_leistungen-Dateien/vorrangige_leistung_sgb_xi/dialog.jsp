...
<% pageProcessor.createSyncPoint("vorrangige_leistung_sgb_xi--vorrangige-leistung-sgb-xi"); %>
<% ((java.util.Set)session.getAttribute("composer.visitedPages")).add("vorrangige_leistung_sgb_xi--vorrangige-leistung-sgb-xi"); %>
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:cit="http://www.cit.de/ns/jsp" xmlns:html="http://www.w3.org/1999/xhtml" lang="de-DE" class="no-js">
   ...
   <body id="vorrangige_leistung_sgb_xi--vorrangige-leistung-sgb-xi">
      <div id="custom_top"/>
      <div id="if">
         <div id="page" class=" has_roadmap_right">
            ...
            <nav id="roadmap" class="roadmap roadmap_right">
               ...
               <ul class="icons"><% final boolean unvisited_d17e2 = !isVisited(session, "vorrangige_leistungen"); %><li class='past<%= unvisited_d17e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("vorrangige_leistungen") != null) { %><span class="item clickable" data-submit-value="resync.vorrangige_leistungen">
                     ...
                     </span><% } %></li><% final boolean unvisited_d17e4 = !isVisited(session, "vorrangige_leistung_sgb_xi"); %><li class='present-perfect<%= unvisited_d17e4 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("vorrangige_leistung_sgb_xi") != null) { %><span class="item clickable" data-submit-value="resync.vorrangige_leistung_sgb_xi">
                        <a href="" class="label">
                     ...
                     <cit:form beanName="myForm">
                        ...
                        <nav id="roadmap_bottom" class="roadmap">
                           ...
                           <ul class="icons"><% final boolean unvisited_d19e2 = !isVisited(session, "vorrangige_leistungen"); %><li class='past<%= unvisited_d19e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("vorrangige_leistungen") != null) { %><span class="item clickable" data-submit-value="resync.vorrangige_leistungen">
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d19e4 = !isVisited(session, "vorrangige_leistung_sgb_xi"); %><li class='present-perfect<%= unvisited_d19e4 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("vorrangige_leistung_sgb_xi") != null) { %><span class="item clickable" data-submit-value="resync.vorrangige_leistung_sgb_xi">
                                    <a href="" class="label">
                                       <span class="labeltext">Vorrangige Leistungen -SGB XI</span>
