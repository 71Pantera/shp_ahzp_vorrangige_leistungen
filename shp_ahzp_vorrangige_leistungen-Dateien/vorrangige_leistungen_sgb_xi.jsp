...
<% pageProcessor.createSyncPoint("vorrangige_leistungen_sgb_xi"); %>
<% ((java.util.Set)session.getAttribute("composer.visitedPages")).add("vorrangige_leistungen_sgb_xi"); %>
   ...
   <head>
    ...
    <cit:theme/>
      ...
      <cit:control>
         ...
         <cit:flow>
            <cit:edit scope="vorrangige_leistungen_sgb_xi" href="vorrangige_leistungen_sgb_xi/dialog.jsp"/>
         </cit:flow>
         <cit:page-validation id="d0e66-multiplicity" test="!(submit=='forward'||submit=='finish')||(length(myForm['vorrangige_leistungen_sgb_xi'])&gt;=1)"/>
      </cit:control>
   </head>
   <body id="vorrangige_leistungen_sgb_xi">
      <div id="custom_top"/>
      <div id="if">
         <div id="page" class=" has_roadmap_right">
            ...
            <nav id="roadmap" class="roadmap roadmap_right">
               ...
               <ul class="icons"><% final boolean unvisited_d11e2 = !isVisited(session, "vorrangige_leistungen"); %><li class='past<%= unvisited_d11e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("vorrangige_leistungen") != null) { %><span class="item clickable" data-submit-value="resync.vorrangige_leistungen">
                     ...
                     </span><% } %></li><% final boolean unvisited_d11e4 = !isVisited(session, "vorrangige_leistungen_sgb_xi"); %><li class='present<%= unvisited_d11e4 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  <section id="content" class=" wide">
                     <cit:form beanName="myForm">
                        <div class="wizard-body">
                           ...
                           <cit:conditional test="length(myForm['vorrangige_leistungen_sgb_xi'])&gt;0">
                              <p class="hint">Folgende Einträge sind vorhanden:</p>
                           </cit:conditional>
                           <section class="block loop wide">
                              <cit:conditional test="length(myForm['vorrangige_leistungen_sgb_xi'])==0">
                                 <p class="hint">Keine Einträge vorhanden. Klicken Sie auf <em class="button-name icon-plus-sign">Vorrangige Leistungen SGB XI hinzufügen</em>, um den ersten Eintrag hinzuzufügen:</p>
                              </cit:conditional><% int no = 0; %><% int count = (Integer) de.cit.jsp.script.ScriptContext.getSessionInstance(session).eval("length(myForm['vorrangige_leistungen_sgb_xi'])", "a *.jsp file"); %><div class="table_container">
                                 <table>
                                    <cit:conditional test="length(myForm['vorrangige_leistungen_sgb_xi'])&gt;0">
                                       <thead>
                                          <tr>
                                    ...
                                    <tbody>
                                       <cit:loop id="d0e66" count="length(myForm['vorrangige_leistungen_sgb_xi'])" scope="vorrangige_leistungen_sgb_xi"><% ++no; %><tr class='<%= ( no % 2 == 0 ? "t-even" : "t-odd" ) + ( no == 1 ? " t-first" : "" ) + ( no == count ? " t-last" : "" ) %>'>
                              ...
                              <cit:loopSubmit loopref="d0e66" type="add" class="submit-add icon-plus-sign" value="Vorrangige Leistungen SGB XI hinzufügen" title="Öffnet das Unterformular zum Hinzufügen eines neuen Eintrags."/>
                           </section>
                        ...
                        <nav id="roadmap_bottom" class="roadmap">
                           ...
                           <ul class="icons"><% final boolean unvisited_d15e2 = !isVisited(session, "vorrangige_leistungen"); %><li class='past<%= unvisited_d15e2 ? " unvisited" : "" %>'><% if (pageProcessor.getSyncPoint("vorrangige_leistungen") != null) { %><span class="item clickable" data-submit-value="resync.vorrangige_leistungen">
                                 ...
                                 </span><% } %></li><% final boolean unvisited_d15e4 = !isVisited(session, "vorrangige_leistungen_sgb_xi"); %><li class='present<%= unvisited_d15e4 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Vorrangige Leistungen -SGB XI</span>
                        ...
                        <div class="wizard-buttons">
                           <div class="wizard-buttons-row">
                              ...
                              <div class="button">
                                 <cit:inputSubmit class="submit-forward" tabindex="0" value="Weiter" type="forward" enabled="js:{true&amp;&amp;(length(myForm['vorrangige_leistungen_sgb_xi'])!=0)}"/>
                              </div>
                           </div>
                        </div>
                     </cit:form>
